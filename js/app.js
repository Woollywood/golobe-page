(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                nouislider.create(item, {
                    start: [ fromValue.dataset.rangeFrom, toValue.dataset.rangeTo ],
                    connect: true,
                    range: {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".slider-login")) new core(".slider-login", {
...
***************************************************************************** */
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest(".pay-flights-book__item") && !targetElement.classList.contains("pay-flights-book__more")) {
                const bookItem = targetElement.closest(".pay-flights-book__item");
                const bookItems = targetElement.closest(".pay-flights-book__item").parentNode.querySelectorAll(".pay-flights-book__item");
                if (bookItems.length) bookItems.forEach((elem => {
                    if (elem.classList.contains("_active")) elem.classList.remove("_active");
                }));
                bookItem.classList.add("_active");
                e.preventDefault();
            }
            if (targetElement.closest(".category-hotel-favourites__column")) {
                e.preventDefault();
                const categoriesBody = targetElement.closest(".category-hotel-favourites__column").parentNode;
                const categoriesItems = categoriesBody.querySelectorAll(".category-hotel-favourites__column");
                categoriesItems.forEach((element => {
                    element.classList.remove("_active");
                }));
                targetElement.closest(".category-hotel-favourites__column").classList.add("_active");
                showCategoryItemAccount(targetElement.closest(".category-hotel-favourites__column").dataset.category);
            }
            if (targetElement.closest("[data-category-account]")) {
                const categoriesBody = targetElement.closest("[data-category-account]").parentNode;
                const categoriesItems = categoriesBody.querySelectorAll("[data-category-account]");
                categoriesItems.forEach((element => {
                    element.classList.remove("_active");
                }));
                targetElement.closest("[data-category-account]").classList.add("_active");
                showCategoryItem(targetElement.closest("[data-category-account]").dataset.categoryAccount);
            }
            if (targetElement.closest("[data-category-account-tickets]")) {
                const categoriesBody = targetElement.closest("[data-category-account-tickets]").parentNode;
                const categoriesItems = categoriesBody.querySelectorAll("[data-category-account-tickets]");
                categoriesItems.forEach((element => {
                    element.classList.remove("_active");
                }));
                targetElement.closest("[data-category-account-tickets]").classList.add("_active");
                showCategoryItemAccountTickets(targetElement.closest("[data-category-account-tickets]").dataset.categoryAccountTickets);
            }
            ...
            function showCategoryItem(itemId) {
                const contentItems = document.querySelectorAll("[data-category-account-item]");
                contentItems.forEach((element => {
                    element.classList.remove("_active");
                }));
                document.querySelector(`[data-category-account-item="${itemId}"]`).classList.add("_active");
            }
            function showCategoryItemAccount(itemId) {
                const contentItems = document.querySelectorAll("[data-category-account-item]");
                contentItems.forEach((element => {
                    element.classList.remove("_active");
                }));
            ...
            function showCategoryItemAccountTickets(itemId) {
                const contentItems = document.querySelectorAll("[data-category-account-item-tickets]");
                contentItems.forEach((element => {
                    element.classList.remove("_active");
                }));
                document.querySelector(`[data-category-account-item-tickets="${itemId}"]`).classList.add("_active");
            }
        }
        window["FLS"] = true;
        isWebp();
